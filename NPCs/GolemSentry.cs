...

{
    public class GolemSentry : ModNPC
    {
            ...
            if (distance <= 700f && Collision.CanHitLine(NPC.position, NPC.width, NPC.height, player.position, player.width, player.height))
            {
                ...
                if (shoottime >= 90)//fires the projectiles
                {
                    ...
                    new Vector2(NPC.Center.X, NPC.Center.Y)) * projectileSpeed;
                        ...
                        Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), new Vector2(NPC.Center.X, NPC.Center.Y - 13), new Vector2(perturbedSpeed.X, perturbedSpeed.Y), type, damage, knockBack);
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore1").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore2").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore3").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore4").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore5").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("GolemSentryGore5").Type, 1f);
