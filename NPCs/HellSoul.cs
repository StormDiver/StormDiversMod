...

{
    public class HellSoul : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("HellSoulGore1").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("HellSoulGore2").Type, 1f);

                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("HellSoulGore3").Type, 1f);
                Gore.NewGore(NPC.Center, NPC.velocity, Mod.Find<ModGore>("HellSoulGore4").Type, 1f);
