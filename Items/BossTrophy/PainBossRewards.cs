...
namespace StormDiversMod.Items.BossTrophy
{
	...
	public class PainBossTrophy : ModItem
	{
		public override void SetStaticDefaults()
		{
			//DisplayName.SetDefault("Ultimate Pain Trophy");
			Item.ResearchUnlockCount = 1;
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<UltimateBossTrophy>();

        }
        public override void SetDefaults()
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<PainBossTrophyPlaced>());
	...
	//______________
	public class PainBossTrophyPlaced : ModTile
	{
		public override void SetStaticDefaults()
		{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, ModContent.ItemType<PainBossTrophy>());
		}*/
	}
	//___________________________RELIC
	public class PainBossRelic : ModItem
	{
		public override void SetStaticDefaults()
		{
			//DisplayName.SetDefault("Ultimate Pain Relic");
			Item.ResearchUnlockCount = 1;
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<UltimateBossRelic>();
        ...
        public override void SetDefaults()
		{
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<PainBossRelicPlaced>(), 0);
	...
	public class PainBossRelicPlaced : ModTile
	{
		...
		public virtual string RelicTextureName => "StormDiversMod/Items/BossTrophy/PainBossRelicPlaced";
		...
		/*public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<PainBossRelic>();
					break;
