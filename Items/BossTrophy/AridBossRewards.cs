...
namespace StormDiversMod.Items.BossTrophy
{
	...
	public class AridBossTrophy : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<AridBossTrophyPlaced>());
	...
	//______________
	public class AridBossTrophyPlaced : ModTile
	{
		public override void SetStaticDefaults()
		{
	...
	public class AridBossRelic : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<AridBossRelicPlaced>(), 0);
	...
	public class AridBossRelicPlaced : ModTile
	{
		...
		public virtual string RelicTextureName => "StormDiversMod/Items/BossTrophy/AridBossRelicPlaced";
		...
		/*public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<AridBossRelic>();
					break;
