...
namespace StormDiversMod.Items.BossTrophy
{
	...
	public class StormBossTrophy : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<StormBossTrophyPlaced>());
	...
	//______________
	public class StormBossTrophyPlaced : ModTile
	{
		public override void SetStaticDefaults()
		{
	...
	public class StormBossRelicPlaced : ModTile
	{
		...
		public virtual string RelicTextureName => "StormDiversMod/Items/BossTrophy/StormBossRelicPlaced";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<StormBossRelic>();
					break;
