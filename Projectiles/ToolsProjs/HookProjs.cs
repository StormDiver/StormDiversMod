...
{
	internal class HookEyeProj : ModProjectile
	{
		...
		{ // This is called once on mod (re)load when this piece of content is being loaded.
		  // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
			chainTexture = ModContent.Request<Texture2D>("StormDiversMod/Projectiles/ToolsProjs/HookEyeChain");
		}
		...
		{
			speed = 14f; // How fast the grapple returns to you after meeting its max shoot distance
		}
	...
	internal class HookDerpProj : ModProjectile
	{
		private static Asset<Texture2D> chainTexture;
		...
		{ // This is called once on mod (re)load when this piece of content is being loaded.
		  // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
			chainTexture = ModContent.Request<Texture2D>("StormDiversMod/Projectiles/ToolsProjs/HookDerpChain");
		}
	...
	internal class HookStormProj : ModProjectile
	{
		private static Asset<Texture2D> chainTexture;
		...
		{ // This is called once on mod (re)load when this piece of content is being loaded.
		  // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
			chainTexture = ModContent.Request<Texture2D>("StormDiversMod/Projectiles/ToolsProjs/HookStormChain");
		}
