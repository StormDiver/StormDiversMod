            ...
            if (speedup == 60)
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                {
                    ...
                    bool lineOfSight = Collision.CanHitLine(Main.MouseWorld, 0, 0, Projectile.position, Projectile.width, Projectile.height);
                        ...
                        shootToX *= distance * 7;
                        shootToY *= distance * 7;
                        Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), new Vector2(Projectile.Center.X, Projectile.Center.Y), new Vector2(shootToX, shootToY), ModContent.ProjectileType<EnchantedSwordProj2>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                    Projectile.Kill();
