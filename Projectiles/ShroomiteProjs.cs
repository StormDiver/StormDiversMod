        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                for (int i = 0; i < numberProjectiles; i++)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), new Vector2(Projectile.Center.X, Projectile.Center.Y), new Vector2(speedX, speedY), ModContent.ProjectileType<ShroomMush>(), (int)(Projectile.damage * 0.4f), Projectile.knockBack, Projectile.owner);
                }
            }
        }
        public override void PostDraw(Color drawColor)
